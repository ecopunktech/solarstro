...
export async function getGeoDataFromRC(rc: string) {
	...
	const polygonRaw = JSONData.FeatureCollection.member["cp:CadastralParcel"]["cp:geometry"]["gml:MultiSurface"]["gml:surfaceMember"]["gml:Surface"]["gml:patches"]["gml:PolygonPatch"]["gml:exterior"]["gml:LinearRing"]["gml:posList"];
